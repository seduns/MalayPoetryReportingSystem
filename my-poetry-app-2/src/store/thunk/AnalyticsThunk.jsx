...
export const getAdminDashboard = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            // ✅ Updated URL to match your request
            const response = await axios.get(`${BASEURL}/poetry/analytics/dashboard/admin`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
...
export const getAuthorDashboard = createAsyncThunk(
    "analytics/author/dashboard",
    async (authorId, { rejectWithValue }) => {
        try {
            const token = localStorage.getItem("accessToken");
            const response = await axios.get(`${BASEURL}/poetry/analytics/dashboard/author/${authorId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
